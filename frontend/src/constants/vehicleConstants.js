...
export const VEHICLE_MOVE_CITY_REQUEST = 'VEHICLE_MOVE_CITY_REQUEST'
export const VEHICLE_MOVE_CITY_SUCCESS = 'VEHICLE_MOVE_CITY_SUCCESS'
export const VEHICLE_MOVE_CITY_FAIL = 'VEHICLE_MOVE_CITY_FAIL'
export const VEHICLE_MOVE_CITY_RESET = 'VEHICLE_MOVE_CITY_RESET'
